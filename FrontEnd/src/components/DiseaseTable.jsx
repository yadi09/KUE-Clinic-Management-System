...
const DiseaseTable = ({ Diseases, title = "NO Title" }) => {
    ...
    const filteredPatients = Diseases.filter(Disease =>
                        ...
                        <table className="min-w-full bg-white">
                            <thead>
                                <tr className="bg-gray-200">
                                    ...
                                    <th className="py-2 px-4 border">Total_Patients</th>
                                </tr>
                            </thead>
                            <tbody>
                                {currentPatients.map((patient) => (
                                    ...
                                    >
                                        <td className="py-2 px-4 border">{patient.disease}</td>
                                        <td className="py-2 px-4 border">{patient.description}</td>
                                        <td className="py-2 px-4 border">{patient.total_patients}</td>
