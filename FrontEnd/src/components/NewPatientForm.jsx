            ...
            <form className="space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" name="name" id="name" value={formData.name || patient?.name} onChange={handleChange}
                    ...
                    <div>
                        ...
                        <input type="text" name="studentId" id="studentId" value={formData.studentId || patient?.studentId} onChange={handleChange}
                            onFocus={(e) => e.target.select()}
                            className="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 text-gray-700 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                    ...
                    <div>
                        ...
                        <input type="text" name="phoneNumber" id="phoneNumber" value={formData.phoneNumber || patient?.phoneNumber} onChange={handleChange}
                            onFocus={(e) => e.target.select()}
                            className="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 text-gray-700 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <select name="gender" id="gender" value={formData.gender || patient?.gender} onChange={handleChange}
                    ...
                    <div>
                        ...
                        <select name="department" id="department" value={formData.department || patient?.department} onChange={handleChange} required
                            className="mt-1 w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-gray-900 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200">
                    ...
                    <div>
                        ...
                        <input type="number" name="year" id="age" value={formData.year || patient?.year} onChange={handleChange} min={1} max={9}
                            onFocus={(e) => e.target.select()}
                            className="mt-1 w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-gray-900 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="age" id="age" value={formData.age || patient?.age} onChange={handleChange}
                            onFocus={(e) => e.target.select()}
                            className="mt-1 w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-gray-900 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                    ...
                    <div>
                        ...
                        <input type="text" name="dormitoryNumber" id="dormitoryNumber" value={formData.dormitoryNumber || patient?.dormitoryNumber} onChange={handleChange}
                            onFocus={(e) => e.target.select()}
                            className="mt-1 w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-gray-900 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    {["region", "wereda", "kebele", "houseNumber"].map((field) => (
                        <div key={field}>
                            ...
                            <input type="text" name={field} id={field} value={formData[field] || patient?.[field]} onChange={handleChange}
                                onFocus={(e) => e.target.select()}
                                className="mt-1 w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-gray-900 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
